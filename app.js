...
console.log('Usuarios en node ' + usernamesInNode)
...
// console.log("Lista de explorers con FIZZZ:") 
...
// console.log("Lista de explorers con BUZZZ: ") 
...
// console.log("Lista de exploreres con fizzbuzz: ") 
...
const assignFizzBuzzTrick2 = function(explorer) {
...
const explorersInNodeAndFizzBuzzTrick2 = explorersInNode.map((explorer) => assignFizzBuzzTrick2(explorer));
console.log("Lista de exploreres in node: ")
console.log(explorersInNode)
console.log("Lista de explorers que contiene FIZZ, BUZZ y FIZZBUZZ:")
console.log(explorersInNodeAndFizzBuzzTrick2)